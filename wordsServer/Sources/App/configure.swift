...
//    services.register(databaseConfig)
    ...
    let postgresConfig = PostgreSQLDatabaseConfig(hostname: "78.47.171.40", port: 5432, username: "postgres", database: nil, password: "postgresspassword12", transport: .cleartext)
